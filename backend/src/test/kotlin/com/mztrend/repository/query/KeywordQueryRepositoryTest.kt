    ...
    fun setUp() {
        ...
        dsl
            .insertInto(
                ...
                KEYWORDS.CATEGORY,
                KEYWORDS.RANK,
            ).values(1L, "teen-second", Generation.TEEN.name, "music", 2)
            .values(2L, "teen-first", Generation.TEEN.name, "game", 1)
            .values(3L, "twenty-first", Generation.TWENTY.name, "beauty", 1)
            .execute()
    }
