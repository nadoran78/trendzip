...
- 구현 중: 제작 이력 기반 운영 키워드 자동 선정과 구조화 대본 초안 생성 파이프라인
...
- 숏폼 샘플은 고정 fixture 기반 실제 TTS까지 검증했고 운영 후보 수집·Gemini 편집 계획·30일 중복 판정·제작 이력 예약과 manifest 생성을 연결했다. 운영 dry-run과 최종 렌더링 승인·게시 파이프라인은 아직 완료하지 않았다.
