...
- 운영 검증 대기: 첫 `PUBLIC_CANDIDATE` 렌더 아티팩트 등록, 사용자의 MP4 전체 재생과 승인·수정 요청·반려 결정
...
1. 첫 운영 공개 후보 영상의 운영 등록과 사람 전체 재생 검수
...
- 첫 운영 워터마크 포함 검수본은 로컬에서 생성·자동 검증했고 운영 DB에도 V8 migration을 배포했다. 이 결과물은 공개·등록 대상으로 사용하지 않는다. 기존 WAV를 재사용해 새 `PUBLIC_CANDIDATE` 렌더(`2026-08-29T05-49-36-784Z-public`, artifact hash `81cb6f7ff9294674fd286ace6872e3d4926e01efb0ee118c667823e8da44f435`)를 만들었고, 내부 표기가 없는 첫 대표 장면과 파일 hash·영상 규격을 확인했다. 이 아티팩트의 등록과 사람 결정은 아직 실행하지 않았으며, 자동 검사는 사람의 발음·음량·전체 흐름 확인을 대신하지 않는다.
